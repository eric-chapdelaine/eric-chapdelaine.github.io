...
$\bar{x} = \frac{M_x}{M} = \frac{\int_{a}^{b} x \delta _L (x) dx }{\int_{a}^{b} \delta_L (x) dx }$
...
$\bar{x} = \frac{\int_{a}^{b} x\delta _{\text{Area}}(x) \left( f(x) - g(x) \right)  dx}{\int_{a}^{b} \delta _{\text{Area}}(x) \left( f(x) - g(x) \right) dx }$
