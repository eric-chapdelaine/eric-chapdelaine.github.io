...
$V^{\text{Shell}} = \int_{0}^{2} 2\pi x\left( 2x^2 - x^3 \right)  dx = 16 \pi$
...
$M = \int_{0}^{1} \delta _{\text{Area}}(x) h(x) dx = \int_{0}^{1} (2x+1) \left( f(x) - g(x) \right) dx$ 

$M = \int_{0}^{1} (2x+1)(x^2-x) dx = \frac{1}{3}$

$M_x = \int_{0}^{1} x \delta _{\text{Area}}(x) h(x) dx = \int_{0}^{1} x (2x+1) \left( x^{2} - x \right) dx = \frac{11}{60}$
