...
It doesn't make sense to store `WikiEntry`s in alphabetical order.
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec27-fig1.png'>
</div>

Does this mean that `B` is better? Well we don't have enough information

<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec27-fig2.png'>
</div>
...
$T(n) \in O(g(n))$
* The big O states the upper bound -- the worst case
...
$n^2 \le c * n$
* No; as big as `c` is, $n^2$ will *always* catch up
...
* The big Omega states the lower board
...
Swaps
* Best case: No swaps
* Worst case: Swap each time, $\frac{n}{2}$ swaps
...
* insertion sort
    * Easy to code
    * Worst case: $O(n^2)$, $\Omega (n)$ (but on average is better)
* selection sort
    * Didn't take any space
    * Always $O(n^2)$, $\Omega (n^2)$
* quick sort
    * $O(n^2)$,  $\Omega (n \log_2 n)$
* merge sort
    * $O(n \log_2 n)$,  $\Omega (n \log_2 n)$ 
* ?
    * $O(n \log_2 n)$,  $\Omega (n \log_2 n)$ with no extra space

# Exam 2 - Second Practice Test

* What is the difference between an abstract class and an interface?
* What is the difference between `super` and `this`?
* Consider the following code and complete the method:
...
* Create the data structures for `Paintings` and `Artists`. Any definition would be acceptable as long as you can get the `Artist` from a `Painting` and vice versa. 

* What is the difference between `for-each`, `counted-for`, and `while` loops?
    * When are each good (and bad) options?

* Consider the following code and complete the methods:
...
* With the following code, (1) create a method that calculates the area of a shape using Visitors, (2) create a method that grows a shape by a given value using Visitors:
...
* Redo your code from the `IList` question above and have all of the methods Visitors.
* Fill in the check expects below:
...
* Recall our definition of `Deque`. Make it so that you can use our defined Deque objects in a `for-each` loop.
* Create an iterator for `Binary Search Trees` that traverses the tree in the order of its values.
* Consider the following code. Fill in the checkExpect
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig1.png'>
</div>
...
Max heap:
* Invariant 1 (Structural): the tree is full on every level, except the last one which is filled in from left to left to right.
* Invariant 2 (Logical): Every child of a node is less than the parent.

Example:

<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig4.png'>
</div>
...
* leftchild(i) = 2i + 1
* rightcild(i) = 2i + 2
* parent(i) = $\lfloor \frac{i-1}{2} \rfloor$ (integer math)
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig5.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec29-fig6.png'>
</div>
...
**Undirected graph**:
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec30-fig1.png'>
</div>
...
**Directed graph**:
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec30-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec30-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec30-fig4.png'>
</div>
...
**DFS**
* worklist: ~~b~~, ~~c~~ (added after d), ~~f~~ (added after a), ~~a~~ (added after c), ~~d~~, ~~f~~
* alreadyseen: b, c, f, a
* next: ~~b~~, ~~c~~, ~~f~~, ~~a~~, ~~b~~, ~~d~~, ~~f~~
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec32-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec32-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec32-fig3.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec32-fig4.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec31-fig1.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec31-fig2.png'>
</div>
...
<div style='width: 100%' class='ui rounded images'>
<img class='ui image' src='/notes/cs2510/lec31-fig3.png'>
</div>
...
**Racket (up to ISL)**:
* Functional language 
* Didn't have to explicit in types. Therefore it is dynamically typed

**Java**:
* Object-oriented with classes
* Statically typed (have to declare types)
...
* Constructors
* Dynamic dispatch
* `this` (an object needs to know about itself)
* Overriding methods
...
Interfaces
* Tell what an object can do -- not what it has
...
* Don't have all of your code in one file
    * Every class and interface should be in its own file
...
* Classes vs interfaces
    * Interfaces tell classes what they should do
    * Represent behavior without implementation
    * Makes programs more flexible
**Abstract Classes**:
* Common behavior, common fields (prevents code duplication)
* Subclasses
    * make it more specific 
    * Add behavior to a library class
    * Special case of a super class

Linked lists, direct access, trees, maps

Generics
* Type parameters, abstract types

**Efficiency and complexity**:
* Differences in constants, n log(n), polynomial, exponential 
...
* Test properly - test fixtures
* Understand how data is passes around, it's stored, saved
* Aliasing
...
* Interface polymorphism (interfaces don't tell you what you need for the fields)
    * Always use the more general type for implementation

Interface polymorphism
* It can be reassigned to other objects in the interface
```java
